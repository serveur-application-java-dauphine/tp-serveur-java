...
public class ServicesSocieteBean implements ServicesSociete {
  ...
  public Societe addSociete(Societe societe) {
    return (Societe) Utilities.doSimple(societe, UtilitiesEnum.INSERT);
  }
  ...
  public Societe updateSociete(Societe societe) {
    return (Societe) Utilities.doSimple(societe, UtilitiesEnum.UPDATE);
  }
  ...
  /**
   * Retourne la liste des actualit�s correspondant � notre soci�t� et tri�s par ordre de cr�ation
   * d�croissante.
   * 
   * @param la
   *          soci�t� pour laquelle on veut les actualit�s

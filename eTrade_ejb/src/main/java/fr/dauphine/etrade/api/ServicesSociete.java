...
public interface ServicesSociete {
	...
	/**
	 * N'est pas possible car si l'on supprime une soci�t�,
	 * tout l'historique des ordres associ�s sera supprim�,
	 * chose totalement inacceptable.
	 * 
	 * Il faut soit la rendre invalide, soit emp�cher la supression.
	 * C'est cette deuxi�me solution qui a �t� choisie.
	 */
